...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $notesModule->note_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $notesModule->note_id)]
            )
        ?></li>
...
<div class="notesModules form large-9 medium-8 columns content">
    <?= $this->Form->create($notesModule) ?>
    <fieldset>
        <legend><?= __('Edit Notes Module') ?></legend>
        <?php
        ?>
    </fieldset>
